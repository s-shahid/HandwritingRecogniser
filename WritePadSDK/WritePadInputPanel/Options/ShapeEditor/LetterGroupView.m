...
static const UCHR * recoCharsGR = "ABCDEFGHIJKLMNOPQRSTUVWXYZß1234567890!@#$%^&*([{-+_=.<«?/|£©";
static const UCHR * recoCharsFR = "ABCDEFGHIJKLMNOPQRSTUVWXYZÇ1234567890!@#$%^&*([{-+_=.<«?/|£©";
static const UCHR * recoCharsSP = "ABCDEFGHIJKLMNOPQRSTUVWXYZÇ1234567890!@#$%^&*([{-+_=.<«?/|£©";
static const UCHR * recoCharsPT = "ABCDEFGHIJKLMNOPQRSTUVWXYZÇ1234567890!@#$%^&*([{-+_=.<«?/|£©";
static const UCHR * recoCharsNL = "ABCDEFGHIJKLMNOPQRSTUVWXYZÇß1234567890!@#$%^&*([{-+_=.<«?/|£©";
static const UCHR * recoCharsIT = "ABCDEFGHIJKLMNOPQRSTUVWXYZÇß1234567890!@#$%^&*([{-+_=.<«?/|£©";
static const UCHR * recoCharsEN = "ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!@#$%^&*([{-+_=.<«?/|£©";
static const UCHR * recoChars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!@#$%^&*([{-+_=.<«?/|£©";
...
{    
    ...
    if (self) 
	{
		...
		_color = [[UIColor colorWithRed:0 green:0 blue:0 alpha:1] retain];
...
+ (NSString *) getCharSet
{
	return [[[NSString alloc] initWithCString:recoChars encoding:RecoStringEncoding] autorelease];
}
...
- (void)drawRect:(CGRect)rect 
{
	...
	for ( int i = 0; i < LI_ARRAY_LENGTH(_lidraw.letter) && _lidraw.letter[i] != 0; i++ ) 
	{
		...
		[sLetter drawInRect:r withFont:[UIFont systemFontOfSize:LETTER_NAME_SIZE]];
