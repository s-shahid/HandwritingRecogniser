...
@interface DictEditViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, UITextViewDelegate, 
                                    EditableTableViewCellDelegate>
{
	UITableView	*		 tableDict;
...
@property (nonatomic, retain) UITableView * tableDict;
