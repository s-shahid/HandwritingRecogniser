...
@class DictImportContacts;

@protocol DictImportContactsDelegate <NSObject>
@optional
...
@interface DictImportContacts : NSObject

{
    Boolean             _importing;
    UIAlertView *		syncProgress;
    NSLock *            _threadLock;
    id <DictImportContactsDelegate> delegate;
}

- (Boolean) importContacts;

@property (nonatomic, assign) id <DictImportContactsDelegate> delegate;
