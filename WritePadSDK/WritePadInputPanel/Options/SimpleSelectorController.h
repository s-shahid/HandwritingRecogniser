...
@interface SimpleSelectorController : UIViewController  <UITableViewDelegate, UITableViewDataSource>
{
	IBOutlet UITableView *		table;
	
	id <SimpleSelectorControllerDelegate> delegate;
...
@property(nonatomic, retain )	NSArray * 	iconnames;
