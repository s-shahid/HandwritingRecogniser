...
@interface WordListEditViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
{
	UITableView	*		 tableWordList;
...
@property (nonatomic, retain) UITableView *	tableWordList;
