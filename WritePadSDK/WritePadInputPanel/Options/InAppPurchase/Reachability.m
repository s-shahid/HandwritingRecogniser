...
- (NetworkStatus)localWiFiConnectionStatus
{
	...
	if ( hasLinkLocalNetworkAccess ) 
	{
		if ( 0 != (selfAssignedAddressFlags & kSCNetworkReachabilityFlagsIsDirect) )
			return ReachableViaWiFiNetwork;
		/*
		else if ( 0 == (selfAssignedAddressFlags & kSCNetworkReachabilityFlagsConnectionRequired) )
			return NotConnectedToWiFi;
		*/
	}
	return NotReachable;
}
