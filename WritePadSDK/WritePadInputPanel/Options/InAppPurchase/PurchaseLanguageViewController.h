...
@class PurchaseLanguageViewController;

@protocol PurchaseLanguageViewControllerDelegate <NSObject>
@optional
- (void)purchaseLanguageControllerTransactionComplete:(PurchaseLanguageViewController *)viewController;
@end


@interface PurchaseLanguageViewController : UIViewController <WritePadStoreDelegate>
{
	id <PurchaseLanguageViewControllerDelegate> delegate;
    
	IBOutlet UIButton * buyButton;
	IBOutlet UIBarItem * restoreButton;
	IBOutlet UIImageView * background;
	IBOutlet UINavigationBar * navBar;
    IBOutlet UILabel * languageName;
    IBOutlet UIImageView * flag;
	IBOutlet UILabel *	connecting;
	IBOutlet UIActivityIndicatorView * waiting;
    NSInteger language_id;
}

@property (nonatomic, assign) id<PurchaseLanguageViewControllerDelegate> delegate;
