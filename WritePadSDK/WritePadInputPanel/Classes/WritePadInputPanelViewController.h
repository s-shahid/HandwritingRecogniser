...
@interface WritePadInputPanelViewController : UIViewController  <UITextViewDelegate, LanguageSelectorControllerDelegate>
{
	WPTextView *      textView;
}

@property (nonatomic, retain)  WPTextView * textView;
