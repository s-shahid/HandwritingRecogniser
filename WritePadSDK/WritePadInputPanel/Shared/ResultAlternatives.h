...
@protocol ResultAlternativesDelegate;

@interface ResultAlternatives : UITableViewController <UIPopoverControllerDelegate>
{
	NSMutableArray *	aWords;
	id<ResultAlternativesDelegate> delegate;
	Boolean addWord;
...
@property (nonatomic, retain) NSMutableArray *	aWords;
@property (nonatomic, assign) id<ResultAlternativesDelegate> delegate;
@property (nonatomic, assign) Boolean addWord;
...
@protocol ResultAlternativesDelegate <NSObject>
@optional
