...
extern "C"
{
	...
	BOOL			INK_AddStroke( INK_DATA_PTR pData, CGStroke pStroke, int nStrokeCnt, int iWidth, COLORREF color );
	...
	int				INK_Serialize( INK_DATA_PTR pData, BOOL bWrite, FILE * pFile, void ** ppData, int * pcbSize, BOOL skipImages, BOOL savePressure );
	BOOL			INK_Paste( INK_DATA_PTR pData, const void * pRawData, UInt32 cbSize, CGPoint atPosition );
	BOOL			INK_Copy( INK_DATA_PTR pData, void ** ppRawData, UInt32 * pcbSize );
